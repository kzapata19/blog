---
layout: post
title:  "The Reasonable Expectations of Your New CTO"
date:   2017-12-04 19:36:36 -0700
categories: Uncle Bob, professionalism, software, career advice
---

Industry standards ensure that their members operate based on a specific and generally accepted set of requirements. These practices help regulate practitioners and are used to hold them accountable when things go wrong.

In "The Reasonable Expectations of Your New CTO", Uncle Bob goes into detail about how software engineers need to hold themselves accountable to a set of standards before the government steps in to regulate the industry. The standards that he laid out include:

### Always be ready
Code should be deployable at the end of the iteration cycle.

### Stable productivity
The pace of code creation should be steady at minimum but ideally over time the rate of code production should increase and so should the quality. Continous Improvement.
...
### Nothing fragile
Code should not break easily. Code must be robust.

### Developer team should cover for one another
